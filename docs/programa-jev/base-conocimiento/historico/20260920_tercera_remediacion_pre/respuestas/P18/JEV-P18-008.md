...
def normalizar_cargo_laboral(texto_cargo_cv: str) -> str:
    try:
        ...
        res = client.system_one(
            state=texto_cargo_cv,
            questions={
                "categoria_isco": Choice(
                    instructions="Mapear a categoria ocupacional estandarizada",
                    options=["desarrollador_software", "analista_datos", "gerente_proyectos", "otro_no_listado"]
                )
            }
        )
