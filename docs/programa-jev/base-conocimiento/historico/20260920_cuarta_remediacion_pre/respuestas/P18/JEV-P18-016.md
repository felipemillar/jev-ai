...
- **Directriz inmediata**: Aplicar y hacer cumplir estrictamente los lineamientos descritos en `JEV-P18-016` para toda nueva iniciativa.
...
- Trazabilidad NotebookLM: Consulta registrada en `consultas/JEV-P18-016.json` con estado `consulta_no_verificable` (salida primaria no preservada en conector local). La fundamentación se apoya en fuentes oficiales externas.
