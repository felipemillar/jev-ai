...
- **Contraejemplo inválido**: Crear 'SRC-0121' para el paper de TypeSafe solo porque fue consultado en la sesión de la tarde desde otro notebook, duplicando 'SRC-0039'.
...
- **Directriz inmediata**: Implementar y mantener rigurosamente la directriz documentada para `JEV-P17-002`.
...
- Trazabilidad NotebookLM: Consulta registrada en `consultas/JEV-P17-002.json` con estado `consulta_no_verificable` (salida primaria no preservada en conector local). La fundamentación se apoya en fuentes oficiales externas.
