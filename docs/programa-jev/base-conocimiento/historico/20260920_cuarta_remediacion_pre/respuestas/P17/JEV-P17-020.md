...
- Trazabilidad NotebookLM: Consulta registrada en `consultas/JEV-P17-020.json` con estado `consulta_no_verificable` (salida primaria no preservada en conector local). La fundamentación se apoya en fuentes oficiales externas.
