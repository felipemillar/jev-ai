...
# JEV-X-008 — Síntesis Transversal, Arquitectura y Gobernanza Integral

## 1. Respuesta directa y decisión que permite tomar
Política común de calidad y calibración: Queda terminantemente prohibido trasladar los umbrales de confianza calibrados en un proyecto (ej. QRT) a otro dominio (ej. Wheelwork) sin ejecutar una reevaluación empírica propia con datos locales.
...
Cada dominio debe medir su propio Error de Calibración Esperado (ECE) y matriz de confusión sobre un dataset representativo de al menos 200 casos.
...
logger = logging.getLogger("JEV-X-008")
...
- **Registro de consulta NotebookLM:** Cuaderno Pilar X (`7051ceed-3234-4060-96c5-93e0267212c1`), consulta registrada el 2026-09-20, archivo de evidencia: `base-conocimiento/remediacion-integral/consultas/JEV-X-008.json`.
