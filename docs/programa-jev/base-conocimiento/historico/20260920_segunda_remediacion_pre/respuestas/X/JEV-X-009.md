...
# JEV-X-009 — Síntesis Transversal, Arquitectura y Gobernanza Integral

## 1. Respuesta directa y decisión que permite tomar
Controles de privacidad y autorización: Comunes: sanitización local de credenciales, tokens y llaves criptográficas antes del transporte; cifrado TLS 1.3 en tránsito; y no retención en disco sin cifrado. Controles específicos adicionales: En flujos personales: redacción de nombres y domicilios; En Wheelwork: anonimización de atributos protegidos (género, edad, etnia); En QRT: aislamiento físico total de terminales de trading respecto a la red de inferencia.
...
La defensa en profundidad se modula según la criticidad y el régimen regulatorio del activo de datos.
...
logger = logging.getLogger("JEV-X-009")
...
- **Registro de consulta NotebookLM:** Cuaderno Pilar X (`7051ceed-3234-4060-96c5-93e0267212c1`), consulta registrada el 2026-09-20, archivo de evidencia: `base-conocimiento/remediacion-integral/consultas/JEV-X-009.json`.
