...
# JEV-X-003 — Síntesis Transversal, Arquitectura y Gobernanza Integral

## 1. Respuesta directa y decisión que permite tomar
Patrones de fallo transversales que bloquean cualquier automatización: (1) Dependencia de razonamiento aritmético o temporal en el modelo de lenguaje; (2) Ausencia de fallback determinista local ante caídas de la API (HTTP 429/529); (3) Presunción de calibración probabilística en datos fuera de dominio (OOD); (4) Escalamiento humano excesivo que devora el ahorro de tokens; y (5) Tratamiento de la salida como verdad fáctica sin verificación de fuentes primarias.
...
Cualquiera de estos patrones detectado en una propuesta de diseño debe activar el veto técnico inmediato.
...
logger = logging.getLogger("JEV-X-003")
...
- **Registro de consulta NotebookLM:** Cuaderno Pilar X (`7051ceed-3234-4060-96c5-93e0267212c1`), consulta registrada el 2026-09-20, archivo de evidencia: `base-conocimiento/remediacion-integral/consultas/JEV-X-003.json`.
