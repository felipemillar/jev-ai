...
# JEV-X-002 — Síntesis Transversal, Arquitectura y Gobernanza Integral

## 1. Respuesta directa y decisión que permite tomar
Matriz de asignación de tareas: (1) Reglas estáticas (Regex/SQL): para condiciones sintácticas exactas y cero coste marginal; (2) Modelos clásicos (Scikit-Learn/XGBoost): para datos tabulares y señales numéricas densas; (3) Motores de búsqueda (Elastic/BM25): para recuperación léxica en corpus masivos; (4) Jev 1.13.0: para clasificación semántica tipada y triaje de alta velocidad en lenguaje natural con coste mínimo; (5) LLMs generativos (GPT-4o/Claude): para síntesis discursiva abierta y redacción de contenido largo; y (6) Operador humano: para decisiones de alto impacto legal, financiero o ético.
...
Se prohíbe utilizar un modelo de nivel superior cuando uno inferior resuelve la tarea con menor coste y riesgo.
...
logger = logging.getLogger("JEV-X-002")
...
- **Registro de consulta NotebookLM:** Cuaderno Pilar X (`7051ceed-3234-4060-96c5-93e0267212c1`), consulta registrada el 2026-09-20, archivo de evidencia: `base-conocimiento/remediacion-integral/consultas/JEV-X-002.json`.
