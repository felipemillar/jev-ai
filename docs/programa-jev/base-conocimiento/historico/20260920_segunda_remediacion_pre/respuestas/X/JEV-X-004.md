...
# JEV-X-004 — Síntesis Transversal, Arquitectura y Gobernanza Integral

## 1. Respuesta directa y decisión que permite tomar
Lista de descubrimiento obligatoria antes de proponer Jev: (1) Problema: ¿Existe una decisión repetitiva de triaje o clasificación semántica?; (2) Datos: ¿Se dispone de un corpus sintético de prueba y se garantiza la ausencia de PII?; (3) Decisión: ¿La acción derivada es reversible o tiene compuerta humana?; (4) Impacto: ¿Cuál es el coste del falso positivo y del falso negativo?; (5) Alternativas: ¿Se probó una solución determinista en CPU?; y (6) Viabilidad: ¿El presupuesto de latencia (< 450 ms p95) tolera el RTT de red?
...
Si la ficha de descubrimiento no acredita ahorros medibles y riesgos acotados, la iniciativa no se promueve a piloto.
...
logger = logging.getLogger("JEV-X-004")
...
- **Registro de consulta NotebookLM:** Cuaderno Pilar X (`7051ceed-3234-4060-96c5-93e0267212c1`), consulta registrada el 2026-09-20, archivo de evidencia: `base-conocimiento/remediacion-integral/consultas/JEV-X-004.json`.
