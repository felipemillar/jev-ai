...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-015, desarrollar herramientas de clasificación arancelaria y comercio exterior.
- **Condición de descarte**: Si en el experimento de validación se observa que errores de codificación aduanera superen el límite legal admisible, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Logística y Comercio Exterior.
