...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-018, diseñar sistemas de alerta temprana ante reclamos regulatorios inminentes.
- **Condición de descarte**: Si en el experimento de validación se observa que notificaciones tardías en eventos de riesgo crítico para la firma, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Compliance y Regulatorio.
