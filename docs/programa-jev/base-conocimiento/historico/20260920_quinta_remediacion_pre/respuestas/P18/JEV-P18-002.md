...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-002, evaluar oportunidades en automatización legal mediante triaje de cláusulas estándar.
- **Condición de descarte**: Si en el experimento de validación se observa que interpretación jurídica dependa de razonamiento abstracto, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Desarrollo de Negocio LegalTech.
