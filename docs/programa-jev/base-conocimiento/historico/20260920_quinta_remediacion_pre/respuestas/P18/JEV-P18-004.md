...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-004, crear herramientas de verificación rápida de consistencia en contratos y facturas.
- **Condición de descarte**: Si en el experimento de validación se observa que tasa de falsos positivos en detección de anomalías supere el 3%, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Ingeniería de Automatización.
