...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-006, prototipar sistemas de clasificación de riesgo crediticio basados en datos cualitativos.
- **Condición de descarte**: Si en el experimento de validación se observa que descalibración en predicción de morosidad supere umbral regulatorio, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Riesgo y Finanzas.
