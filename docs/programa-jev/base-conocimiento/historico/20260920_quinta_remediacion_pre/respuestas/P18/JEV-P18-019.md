...
El diseño y factibilidad de nuevos productos relativos a `JEV-P18-019` (¿Qué cartera de experimentos combina mejoras inmediatas, exploración de may...) se circunscriben rigurosamente a la frontera de decisiones semánticas de bajo costo y alta calibración. Para una visión integral de las heurísticas de producto, matrices multicriterio de priorización y directrices contra la comoditización, consúltese la [Síntesis P18](../sintesis/P18.md), la cual fundamenta la hipótesis de valor aplicada puntualmente en esta evaluación.
...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-019, construir clasificadores de intención para interfaces de voz en telefonía.
- **Condición de descarte**: Si en el experimento de validación se observa que tasa de transferencia a operador humano por desvío supere el 20%, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Tecnología de Voz y Telefonía.
