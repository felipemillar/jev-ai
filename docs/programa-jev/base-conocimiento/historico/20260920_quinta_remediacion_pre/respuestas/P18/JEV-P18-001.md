...
El diseño y factibilidad de nuevos productos relativos a `JEV-P18-001` (¿Qué capacidades verificadas abren oportunidades distintas de usar un LLM g...) se circunscriben rigurosamente a la frontera de decisiones semánticas de bajo costo y alta calibración. Para una visión integral de las heurísticas de producto, matrices multicriterio de priorización y directrices contra la comoditización, consúltese la [Síntesis P18](../sintesis/P18.md), la cual fundamenta la hipótesis de valor aplicada puntualmente en esta evaluación.
...
- **Directriz inmediata**: En la cartera de nuevos productos vinculada a JEV-P18-001, diseñar productos exclusivamente sobre capacidades discriminativas de clasificación.
- **Condición de descarte**: Si en el experimento de validación se observa que propuestas comerciales requieran generación de prosa libre, desestimar la oportunidad y documentar el motivo.
- **Responsable de ejecución**: Estrategia de Producto.
