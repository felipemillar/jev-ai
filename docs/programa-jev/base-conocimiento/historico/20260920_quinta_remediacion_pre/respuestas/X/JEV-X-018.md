...
- **Directriz inmediata**: En el marco de JEV-X-018, calibrar la temperatura de inferencia y evaluar la entropía de decisión en producción de forma verificable.
- **Condición de descarte**: Si se detecta que error de calibración esperado (ECE) supere 0.08 en evaluación, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Investigación Aplicada y ML.
