...
- **Directriz inmediata**: En el marco de JEV-X-022, validar el cumplimiento de estándares bancarios y financieros locales e internacionales de forma verificable.
- **Condición de descarte**: Si se detecta que hallazgos de no conformidad en auditoría externa regulatoria, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Oficial de Cumplimiento Normativo.
