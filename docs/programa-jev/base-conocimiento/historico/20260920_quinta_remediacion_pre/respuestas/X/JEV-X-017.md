...
- **Directriz inmediata**: En el marco de JEV-X-017, consolidar la documentación canónica como fuente única de verdad en el monorepo de forma verificable.
- **Condición de descarte**: Si se detecta que divergencia entre guías operativas y código exceda 0 discrepancias, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Equipo de Documentación y Conocimiento.
