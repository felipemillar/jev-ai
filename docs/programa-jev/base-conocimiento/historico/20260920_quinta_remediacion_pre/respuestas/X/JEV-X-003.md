...
- **Directriz inmediata**: En el marco de JEV-X-003, auditar el aislamiento de credenciales y tokens mediante rotación criptográfica quincenal de forma verificable.
- **Condición de descarte**: Si se detecta que detección de claves estáticas en repositorios de código, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Oficina de Ciberseguridad y Cumplimiento.
