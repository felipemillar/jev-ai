...
- **Directriz inmediata**: En el marco de JEV-X-002, desplegar el patrón Circuit Breaker con conmutación determinista a fallbacks locales de forma verificable.
- **Condición de descarte**: Si se detecta que tasa de error 5xx exceda el 2% en ventana de 60 segundos, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Equipo de Conectores y Resiliencia.
