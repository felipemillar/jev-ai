...
- **Directriz inmediata**: En el marco de JEV-X-007, calibrar los umbrales de abstención según la matriz de costos asimétricos de negocio de forma verificable.
- **Condición de descarte**: Si se detecta que costo del error residual supere el beneficio de automatización, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Mesa Cuantitativa QRT.
