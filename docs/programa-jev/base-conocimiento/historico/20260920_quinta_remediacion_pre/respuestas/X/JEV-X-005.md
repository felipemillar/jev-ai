...
- **Directriz inmediata**: En el marco de JEV-X-005, restringir la memoria conversacional upstream mediante sandboxing estricto en CPU de forma verificable.
- **Condición de descarte**: Si se detecta que fuga de contexto identifique persistencia no autorizada, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Comité de Privacidad de Datos.
