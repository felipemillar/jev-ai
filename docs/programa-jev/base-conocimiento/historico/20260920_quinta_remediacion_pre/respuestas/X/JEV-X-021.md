...
- **Directriz inmediata**: En el marco de JEV-X-021, establecer protocolos de prueba de estrés ante picos de demanda en horas de alta volatilidad de forma verificable.
- **Condición de descarte**: Si se detecta que degradación de latencia supere el factor de 2.5x bajo carga, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Ingeniería de Rendimiento y Carga.
