...
- **Directriz inmediata**: En el marco de JEV-X-006, incorporar compuertas de doble firma humana en toda decisión de reclasificación contractual de forma verificable.
- **Condición de descarte**: Si se detecta que tasa de divergencia humana supere el 5% en auditoría ciega, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Equipo de Operaciones Wheelwork.
