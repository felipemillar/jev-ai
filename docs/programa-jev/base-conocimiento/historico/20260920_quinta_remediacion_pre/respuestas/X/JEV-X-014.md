...
- **Directriz inmediata**: En el marco de JEV-X-014, definir políticas de retención y purga inmediata de payloads en memoria volátil de forma verificable.
- **Condición de descarte**: Si se detecta que retención de estados en buffer supere los 300 segundos, detener inmediatamente el flujo operativo y convocar a revisión técnica.
- **Responsable de ejecución**: Gobernanza de Datos Corporativos.
