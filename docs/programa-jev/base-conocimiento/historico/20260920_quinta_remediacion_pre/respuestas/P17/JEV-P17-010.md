...
- **Directriz inmediata**: Para JEV-P17-010, controlar la obsolescencia de fuentes mediante marcas temporales y versiones de SDK en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que referencias a versiones de software deprecadas sin advertencia, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Mantenimiento de Documentación.
