...
- **Directriz inmediata**: Para JEV-P17-016, definir criterios de saturación documental para declarar cerrada una investigación en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que búsqueda interminable sin incremento marginal de conocimiento útil, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Coordinador de Investigación.
