...
- **Directriz inmediata**: Para JEV-P17-012, construir matrices de evidencia cruzada para preguntas con múltiples fuentes en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que conclusiones basadas en una única fuente no oficial, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Analistas de Inteligencia Técnica.
