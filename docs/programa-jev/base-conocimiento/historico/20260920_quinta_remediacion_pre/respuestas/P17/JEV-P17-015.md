...
- **Directriz inmediata**: Para JEV-P17-015, verificar la coherencia lógica de las cadenas de decisión documentadas en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que falacias de afirmación del consecuente en diseño de sistemas, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Auditoría de Procesos Lógicos.
