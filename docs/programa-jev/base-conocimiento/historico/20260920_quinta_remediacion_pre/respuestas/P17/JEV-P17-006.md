...
- **Directriz inmediata**: Para JEV-P17-006, preservar los logs crudos de consultas y respuestas para trazabilidad auditable en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que ausencia de telemetría de interacción en el directorio local, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Sistemas de Auditoría y Logs.
