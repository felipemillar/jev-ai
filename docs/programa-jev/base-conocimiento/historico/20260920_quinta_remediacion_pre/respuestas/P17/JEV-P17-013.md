...
- **Directriz inmediata**: Para JEV-P17-013, estandarizar el vocabulario técnico para evitar ambigüedades entre pilares en la infraestructura documental.
- **Condición de descarte**: Si en auditoría periódica se verifica que polisemia no resuelta que genere contradicciones operativas, congelar la actualización y abrir reporte de desviación.
- **Responsable de ejecución**: Comité de Estandarización.
